...
@section('pengguna_content')
    ...
    <div class="page-title dark-background no-print"
        style="background-image: url({{ asset('assets/img/hero-carousel/5.jpg') }});">
    ...
    <section id="blog-posts" class="blog-posts section">
        <div class="container">
            <div class="row gy-4">
                @if ($pengumuman_pengguna->isEmpty())
                    <div class="col-12">
                        <p class="text-center">Belum ada pengumuman yang tersedia.</p>
                    </div>
                @else
                    @foreach ($pengumuman_pengguna as $item)
                        @php
    ...
    <footer id="footer" class="footer dark-background no-print">
        @include('pengguna.component.footer') {{-- Pastikan path footer ini benar --}}
    </footer>
