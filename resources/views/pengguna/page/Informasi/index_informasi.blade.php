    ...
    <section id="blog-pagination" class="blog-pagination section mt-5 no-print">
        <div class="container">
            <ul class="nav nav-tabs justify-content-center">
                <li class="nav-item">
                    <a class="nav-link {{ Request::routeIs('informasi.pengguna') ? 'active' : '' }}"
                        href="{{ route('informasi.pengguna') }}"> Berita </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Request::routeIs('pengumuman.pengguna') ? 'active' : '' }}"
                        href="{{ route('pengumuman.pengguna') }}"> Pengumuman </a>
                </li>
            </ul>
        </div>
    </section>
                                    ...
                                    @if ($lampiranAda)
                                        @if (in_array($fileExtension, ['jpg', 'jpeg', 'png', 'gif']))
                                            <img src="{{ $fileUrl }}" class="img-fluid" alt="Gambar Berita"
                                                style="max-height: 260px; object-fit: contain;"> {{-- Diubah alt text --}}
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <label for="judul_informasi_edit_berita_{{ $item->id_informasi }}"
                                                class="form-label">Judul Berita</label> {{-- Diubah id dan for --}}
                                        ...
                                        <div class="mb-3">
                                            <label for="deskripsi_informasi_edit_berita_{{ $item->id_informasi }}"
                                                class="form-label">Deskripsi Berita</label> {{-- Diubah id dan for --}}
                                        ...
                                        <div class="mb-3">
                                            <label for="lampiran_informasi_edit_berita_{{ $item->id_informasi }}"
                                                class="form-label">Ganti Lampiran (Opsional)</label> {{-- Diubah id dan for --}}
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" id="status_draft_tambah_brt"
                                        name="status_informasi" value="0"
                                        {{ old('status_informasi', '0') == '0' ? 'checked' : '' }}> {{-- Diubah id --}}
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" id="status_publish_tambah_brt"
                                        name="status_informasi" value="1"
                                        {{ old('status_informasi') == '1' ? 'checked' : '' }}> {{-- Diubah id --}}
