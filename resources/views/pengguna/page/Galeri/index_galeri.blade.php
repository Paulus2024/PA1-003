    ...
    @section('pengguna_content')
                        ...
                        <div class="col-lg-4 col-md-6 mb-4"> {{-- Menggunakan col-lg-4 dan col-md-6 untuk responsivitas lebih baik --}}
                            <div class="gallery-item">
                                ...
                                <div class="overlay">
                                    ...
                                    <button type="button" class="btn btn-sm btn-outline-light zoom-button"
                            ...
                            <div class="modal-dialog modal-xl modal-dialog-centered"> {{-- modal-xl untuk gambar besar --}}
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="{{ $modalId }}Label">{{ $item->judul_galeri }}
                                        </h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body text-center"> {{-- text-center untuk gambar di tengah modal-body --}}
                                        <img src="{{ asset('storage/' . $item->gambar_galeri) }}" class="img-fluid"
        ...
        <style>
            .gallery-item {
                ...
                overflow: hidden;
                height: 250px;
                /* Tinggi default untuk item galeri */
                background-color: #e9ecef;
                /* Warna placeholder jika gambar lambat dimuat */
                border-radius: 0.375rem;
                /* Sedikit rounded corner, sesuaikan dengan tema Bootstrap */
            ...
            .gallery-item img {
                ...
                height: 100%;
                object-fit: cover;
                /* Memastikan gambar mengisi tanpa distorsi */
                display: block;
            ...
            .gallery-item:hover img {
                transform: scale(1.1);
                /* Efek zoom halus pada gambar thumbnail saat hover */
            }
            ...
            .gallery-item .overlay {
                ...
                right: 0;
                bottom: 0;
                /* Memastikan overlay menutupi seluruh item */
            ...
            .gallery-item .overlay .zoom-button svg {
                margin-right: 5px;
                /* Jarak antara ikon dan teks "Zoom" */
            }
            ...
            .modal-title {
                color: #212529;
                /* Warna teks default Bootstrap */
            }

            .modal-body img {
                max-height: 80vh;
                /* Batasi tinggi gambar di modal agar tidak terlalu panjang */
                display: block;
                margin-left: auto;
                margin-right: auto;
            }
