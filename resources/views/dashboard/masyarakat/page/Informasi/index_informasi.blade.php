    ...
    <section id="blog-pagination" class="blog-pagination section mt-5">
        <div class="container">
            <ul class="nav nav-tabs justify-content-center">
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('informasi.masyarakat') ? 'active' : '' }}"
                        href="{{ route('informasi.masyarakat') }}"> Berita </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('pengumuman.masyarakat') ? 'active' : '' }}"
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="judul_informasi"
                                            name="judul_informasi" value="{{ $item->judul_informasi }}" required>
                                    </div>
                                    <div class="mb-3">
