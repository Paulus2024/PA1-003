...
@section(section: 'sekretaris_content')
    ...
    <section id="projects" class="projects section">
        ...
        <div class="container">
            ...
            {{-- TAMBAHKAN ROW DI LUAR LOOP --}}
            <div class="row">
                @foreach ($galleries as $item)
                    <div class="col-md-4 mb-4">
                        <div class="gallery-item">
                            <img src="{{ asset('storage/' . $item->gambar_galeri) }}" class="img-fluid" alt="Gambar 1">
                            <div class="overlay">{{ Str::limit(value: $item->judul_galeri, limit: 50) }}</div>
                        </div>
                    ...
                    <div class="modal fade" id="editModal{{ $item->id_galeri }}" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <form action="{{ route('galleries.update', $item->id_galeri) }}" method="POST"
            ...
            <div class="col-12">
                <div class="d-grid gap-2">
                    ...
                    <button class="btn btn-success" type="button" data-bs-toggle="modal"
                        data-bs-target="#TambahGambar">Tambah Gambar Galeri</button>
                </div>
            </div>
